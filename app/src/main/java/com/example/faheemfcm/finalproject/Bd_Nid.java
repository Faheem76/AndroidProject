...
public class Bd_Nid extends AppCompatActivity  implements SwipeRefreshLayout.OnRefreshListener {
   ...
   // ZoomControls zoom;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_bd__nid);

      /*  zoom=(ZoomControls)findViewById(R.id.ZoomNid);
        zoom.setOnZoomInClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                webView.setScaleX((int)(x+1));
                webView.setScaleY((int)(y+1));
            }
        });
        ...
        progressBar = (ProgressBar)findViewById(R.id.progressBarBdNid);
        webView = (WebView)findViewById(R.id.webBDNid);
  ...
  /*  private class ScaleListner extends ScaleGestureDetector.SimpleOnScaleGestureListener{
        ...
        public boolean onScale(ScaleGestureDetector detector) {
            ...
            webView.setWebViewClient(matrix);
            return true;
        }
    }*/
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        switch (item.getItemId()){
            ...
            case R.id.About:
                ...
                break;
            case R.id.Home:
                Intent intent=new Intent(Bd_Nid.this,MainActivity.class);
